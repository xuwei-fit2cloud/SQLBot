from apps.chat.schemas.utils import examples_to_str, read_json, write_json
...
class MSchema:
    ...
    def to_mschema(self, selected_tables: List = None, selected_columns: List = None,
        ...
        Args:
            selected_tables: None means select all tables
            selected_columns: None means select all columns, format: ['table_name.column_name']
            example_num: Number of examples to show for each field
            show_type_detail: Whether to show detailed type information
        ...
        # Process selected tables and columns
        ...
        # Add foreign key information, skip when table_type is view
    ...
    def dump(self):
        """
        Dump schema information to dictionary
