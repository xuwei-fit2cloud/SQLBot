  ...
  <div class="model-config">
    ...
    <div v-else class="card-content">
      <Card
        ...
        :name="ele.name"
        :modleType="getModelTypeName(ele.type)"
        :baseModle="ele.baseModle"
        :id="ele.id"
    ...
    >
      ...
      <ModelList v-if="activeStep === 0" @clickModel="clickModel"></ModelList>
      <ModelListSide
        :activeName="activeName"
        v-if="activeStep === 1"
        @clickModel="clickModelSide"
      ></ModelListSide>
      <ModelForm
        @submit="submit"
        ref="modelFormRef"
      ...
      <template #footer>
        ...
        <el-button @click="preStep" secondary> 上一步 </el-button>
